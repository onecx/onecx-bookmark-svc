...
import org.tkit.onecx.bookmark.domain.config.BookmarkConfig;
...
public class AbstractTest {
    ...
    public static String createToken(String organizationId) {
        try {
    ...
    public static class ConfigProducer {
        ...
        BookmarkConfig config() {
            return config.unwrap(SmallRyeConfig.class).getConfigMapping(BookmarkConfig.class);
        }
    }
